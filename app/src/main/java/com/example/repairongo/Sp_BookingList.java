...
public class Sp_BookingList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Query event=database.orderByChild("sp_checker").equalTo(mAuth.getCurrentUser().getUid()+txt);
        sp_recyclerview.setLayoutManager(new LinearLayoutManager(Sp_BookingList.this));
